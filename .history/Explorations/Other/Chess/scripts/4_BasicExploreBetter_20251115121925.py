...
"""
Analyze your performance relative to opponents of different ratings.
Takeaway: Understand how often you win against higher-rated players vs lower-rated,
with more granularity for small rating differences.
"""
...
# Scatter plot of raw performance vs rating difference
plt.figure(figsize=(8,4))
...
# Define finer-grained bins for small differences
bins = [-500, -100, -50, -30, -20, -10, 0, 10, 20, 30, 50, 100, 500]
labels = ["Much stronger", "Stronger", "-50", "-30", "-20", "-10",
          "Equal", "+10", "+20", "+30", "+50", "+100", "Much weaker"]
